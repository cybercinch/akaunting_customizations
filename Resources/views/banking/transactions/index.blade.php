    ...
    <x-slot name="content">
                                    ...
                                    @foreach($transactions as $item)
                                        <x-table.tr href="{{ route('transactions.show', $item->id) }}">
                                            ...
                                            <x-table.td class="w-3/12 hidden sm:table-cell">
                                                ...
                                                <x-slot name="second" class="font-normal group" data-tooltip-target="tooltip-information-{{ $item->id }}" data-tooltip-placement="left" override="class">
                                                    {{ $item->description }}
                                                </x-slot>
                                            </x-table.td>
        ...
        @else
            <x-empty-page
                    ...
                    [
                        'url' => route('import.create', ['banking', 'transactions']),
                        'permission' => 'create-banking-transactions',
